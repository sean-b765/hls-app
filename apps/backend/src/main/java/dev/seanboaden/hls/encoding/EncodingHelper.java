...
public class EncodingHelper {
    /*
     * ffmpeg
     *  -i "E:\Stuff\Media\TV\Game of Thrones\Season 1\Game of Thrones S01E02 - The Kingsroad.mkv"
     *  -preset superfast
     *  -map 0:v
     *  -map 0:a
     *  -codec:v libx264
     ...
     *  -g:v:0 96 (set groups of pictures to framerate * segment length = 4)
     *  -keyint_min:v:0 96
     *  -x264opts:0 "no-scenecut=1:subme=0:me_range=16:rc_lookahead=0:me=hex:open_gop=0"
     *  -sc_threshold:v:0 0
     *  -bf 0
     *  -r 23.97598 (frame rate of source file)
     *  -fps_mode cfr (use constant frame rate)
     *  master.m3u8
     */
