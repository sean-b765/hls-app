...
<template>
  <div class="w-full h-full gap-4 max-h-[calc(100vh-96px)] overflow-y-auto rounded-lg">
    <div class="w-full flex flex-col gap-4">
      ...
      <!-- Overview -->
      <div
        class="w-full relative flex items-center gap-3 h-80 overflow-hidden rounded-lg bg-muted/70"
      >
        <div class="w-full h-full absolute p-2 z-0 box-border">
          <div
            class="w-full h-full absolute bg-cover p-2 bg-center opacity-50 rounded"
        ...
        <div class="w-full flex flex-col flex-1 py-2 px-8 truncate z-10">
