...
export const MoviesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        findByIds2: async (requestBody: Array<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/movies/fetch`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const MoviesApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async create2(media: Media, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Media>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['MoviesApi.create2']?.[localVarOperationServerIndex]?.url;
        ...
        async deleteById2(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MoviesApi.deleteById2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async deleteByIds2(requestBody: Array<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MoviesApi.deleteByIds2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async findAll2(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Media>>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MoviesApi.findAll2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async findById2(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Media>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MoviesApi.findById2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async findByIds2(requestBody: Array<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Media>>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MoviesApi.findByIds2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async upsert2(media: Media, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Media>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MoviesApi.upsert2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export class MoviesApi extends BaseAPI {
    ...
    public create2(media: Media, options?: RawAxiosRequestConfig) {
        return MoviesApiFp(this.configuration).create2(media, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public deleteById2(id: string, options?: RawAxiosRequestConfig) {
        return MoviesApiFp(this.configuration).deleteById2(id, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public deleteByIds2(requestBody: Array<string>, options?: RawAxiosRequestConfig) {
        return MoviesApiFp(this.configuration).deleteByIds2(requestBody, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public findAll2(options?: RawAxiosRequestConfig) {
        return MoviesApiFp(this.configuration).findAll2(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public findById2(id: string, options?: RawAxiosRequestConfig) {
        return MoviesApiFp(this.configuration).findById2(id, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public findByIds2(requestBody: Array<string>, options?: RawAxiosRequestConfig) {
        return MoviesApiFp(this.configuration).findByIds2(requestBody, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public upsert2(media: Media, options?: RawAxiosRequestConfig) {
        return MoviesApiFp(this.configuration).upsert2(media, options).then((request) => request(this.axios, this.basePath));
    }
}
